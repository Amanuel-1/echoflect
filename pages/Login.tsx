...
import { ValueLogin } from '@/lib/types';
...
export default function Login(){
    ...
    return (
        ...
        <section className='w-[90%] py-[3rem] mx-auto flex flex-col gap-10'>
            <div className="title"> 
            ...
            <form className='flex flex-col gap-5' onSubmit={formik.handleSubmit}>
                ...
                <div className="input-button">
                    <button type='button' onClick={handleFacebookSignin} className={`flex gap-4 items-center bg-indigo-600 ${styles.button_custom} `} >
                        <Image src={Images.facebook} alt='google' width={25} height={25} />
                        <p>Sign In with Facebook </p>
                    </button>
                </div>
                            {/* bottom */}
            <p className='text-center text-gray-400 my-[2rem] '>
