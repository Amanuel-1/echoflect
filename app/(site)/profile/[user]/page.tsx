...
const Profile =() => {
  ...
  return (
    <section className=" min-h-screen  md:px-20 text-stone-700 dark:text-stone-200">
     ...
     <div className="flex flex-col gap-1 justify-center pt-[100px] pb-[20px] h-fit w-full bg-stone-50 dark:bg-stone-900">
