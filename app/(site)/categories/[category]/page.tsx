  ...
  return (
    ...
    <div className='w-full flex flex-col md:p-[1rem] rounded-[5px]'>
      ...
      <Box className=' grid grid-cols-1 md:grid-cols-2 gap-6 dark:bg-gray-950 border-none'>
       {
        postData && postData.map((post:IPost,i)=>(
          ...
          <Image className='rounded-t-[15px]' src={post.thumbnail.startsWith('cover')?'':post.thumbnail} alt={post.title} layout="fill" objectFit="cover"/>
          </div>
