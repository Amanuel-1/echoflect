  ...
  return (
    <div className="flex  align-middle justify-center items-center min-w-screen bg-inherit ">
        ...
        <div className=" w-full flex gap-0 justify-center md:px-[10rem] ">
            ...
            <input className=' w-full  py-4 px-6  rounded-l-[10px] bg-[#ffffff] dark:bg-stone-900 outline-none  border-neutral-100 dark:border-stone-900 focus:bg-neutral-50 border-2' type='text' placeholder='search here ' />
            <button className='absolute right-0 px-4 h-full hover:text-stone-600'><HiAdjustmentsHorizontal size={35} /></button>
            </div>
