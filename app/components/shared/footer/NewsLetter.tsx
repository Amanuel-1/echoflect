  ...
  return (
    ...
    <div>
      <ul className="flex flex-col gap-6 justify-center w-full transition-all duration-700 ease-in-out">
        ...
        <li className='flex justify-center w-full '><button className='justify-center py-4 w-full bg-gradient-to-r from-pink-950 hover:from-slate-600 via-red-600 hover:via-indigo-600 to-pink-800 rounded-xl text-stone-300 text-xl  font-extrabold transition-all duration-700 ease-in-out'>Subscribe</button></li>
      </ul>
    </div>
  )
};
